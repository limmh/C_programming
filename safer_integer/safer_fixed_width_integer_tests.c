...
{
	ASSERT_INT64_EQUAL(i32add(-2147483648L, -2147483648L), -4294967296LL);
	ASSERT_INT64_EQUAL(i32add(-2147483648L, -1), -2147483649LL);
	ASSERT_INT64_EQUAL(i32add(0, 0), 0);
	ASSERT_INT64_EQUAL(i32add(2147483647L, 1), 2147483648LL);
	ASSERT_INT64_EQUAL(i32add(2147483647L, 2147483647L), 4294967294LL);
}

TEST(i32sub_tests, "i32sub tests")
{
	ASSERT_INT64_EQUAL(i32sub(-2147483648L, -2147483648L), 0);
	ASSERT_INT64_EQUAL(i32sub(-2147483648L, 2147483647L), -4294967295LL);
	ASSERT_INT64_EQUAL(i32sub(0, 0), 0);
	ASSERT_INT64_EQUAL(i32sub(2147483647L, -2147483648L), 4294967295LL);
	ASSERT_INT64_EQUAL(i32sub(2147483647L, 2147483647L), 0);
}

TEST(i32mul_tests, "i32mul tests")
{
	ASSERT_INT64_EQUAL(i32mul(-2147483648L, -2147483648L), 4611686018427387904LL);
	ASSERT_INT64_EQUAL(i32mul(-2147483648L, 2147483647L), -4611686016279904256LL);
	ASSERT_INT64_EQUAL(i32mul(0, 0), 0);
	ASSERT_INT64_EQUAL(i32mul(2147483647L, -2147483648L), -4611686016279904256LL);
	ASSERT_INT64_EQUAL(i32mul(2147483647L, 2147483647L), 4611686014132420609LL);
}

TEST(i32div_tests, "i32div tests")
{
	ASSERT_INT64_EQUAL(i32div(-2147483648L, -2147483648L), 1);
	ASSERT_INT64_EQUAL(i32rem(-2147483648L, -2147483648L), 0);

	ASSERT_INT64_EQUAL(i32div(-2147483648L, 2147483647L), -1);
	ASSERT_INT64_EQUAL(i32rem(-2147483648L, 2147483647L), -1);

	ASSERT_INT64_EQUAL(i32div(-2147483648L, -1), 2147483648LL);
	ASSERT_INT64_EQUAL(i32rem(-2147483648L, -1), 0);

	ASSERT_INT64_EQUAL(i32div(2147483647L, -2147483648L), 0);
	ASSERT_INT64_EQUAL(i32rem(2147483647L, -2147483648L), 2147483647L);

	ASSERT_INT64_EQUAL(i32div(2147483647L, 2147483647L), 1);
	ASSERT_INT64_EQUAL(i32rem(2147483647L, 2147483647L), 0);
}
